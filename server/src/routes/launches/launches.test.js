...
describe('Launches API', () => {
    ...
    describe('Test POST /launches', () => {
        const completeLaunchData = {
            mission: 'USS Enterprise D',
            rocket: 'NCC 1701-D',
            target: 'Kepler-62 f',
            launchDate: 'January 4, 2024',
        };
    
        const completeLaunchDataWithtoutDate = {
            mission: 'USS Enterprise D',
            rocket: 'NCC 1701-D',
            target: 'Kepler-62 f',
        };
        ...
        test('It should respond with 201 created', async () => {
            ...
            expect(response.body).toMatchObject(completeLaunchDataWithtoutDate);
        ...
        test('It should catch missing required properties', async () => {
            const response = await request(app)
                                    .post('/launches')
                                    .send(completeLaunchDataWithtoutDate)
                                    .expect('Content-Type', /json/)
                                    .expect(400);
